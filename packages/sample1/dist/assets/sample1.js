...
define("sample1/child-app/tests/addon.lint-test", [], function () {
  "use strict";
});
...
define("sample1/templates/application", ["exports"], function (exports) {
  ...
  exports.default = Ember.HTMLBars.template({ "id": "QASwVbOS", "block": "{\"symbols\":[],\"statements\":[[6,\"h1\"],[7],[0,\"Application\"],[8],[0,\"\\n\"],[4,\"link-to\",[\"home\"],null,{\"statements\":[[0,\"Home page\"]],\"parameters\":[]},null],[0,\"\\n\"],[4,\"link-to\",[\"page1\"],null,{\"statements\":[[0,\"sub page\"]],\"parameters\":[]},null],[0,\"\\n\"],[4,\"link-to\",[\"child-app.child-home\"],null,{\"statements\":[[0,\"child page 1\"]],\"parameters\":[]},null],[0,\"\\n\"],[4,\"link-to\",[\"child-app.child-home1\"],null,{\"statements\":[[0,\"child page 2\"]],\"parameters\":[]},null],[0,\"\\n\\n\"],[1,[18,\"outlet\"],false],[0,\"\\n\"]],\"hasEval\":false}", "meta": { "moduleName": "sample1/templates/application.hbs" } });
});
...
if (!runningTests) {
  require("sample1/app")["default"].create({"name":"sample1","version":"0.0.1+2237c05e"});
}
